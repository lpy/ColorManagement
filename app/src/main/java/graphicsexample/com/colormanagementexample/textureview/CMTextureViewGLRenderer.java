...
public class CMTextureViewGLRenderer implements CMGLProducerThread.GLRenderer {
    ...
    private int mTexID;
    private static String TAG = "CMTextureViewGLRenderer";
    ...
    public CMTextureViewGLRenderer(Context ctx) {
